...
# .env dosyasından veya Streamlit secrets'tan API key'i oku
api_key = os.getenv("OPENAI_API_KEY", "")

# Streamlit Cloud için secrets kontrolü
...
if api_key:
    ...
    st.sidebar.warning("💡 Streamlit Cloud'da secrets bölümünden OPENAI_API_KEY ekleyin")
